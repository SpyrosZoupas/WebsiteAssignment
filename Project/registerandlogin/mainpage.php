    ...
    <header>
        <nav>
            ...
            <ul class="navbar-list">
                ...
                <li class="navbar-list--item"><a class="btn-underline" href="" class="navbar-button plan">Plans & Pricing</a></li>
    ...
    <div class="hero">
        <div class="hero-left">
            ...
            <ul class="hero-left--buttons">
                ...
                <li class="hero-left--button register"><a href="#">Register</a></li>
            </ul>
        </div>
